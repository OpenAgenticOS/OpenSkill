...
objective: |-
  ...
  **与新品上市简报区分**：本技能为**长期品牌与品类**定位；[新品上市简报](./product_launch_messaging_brief.zh.skill.md) 为**单品活动**。
style: 结构化：For [target], we are [frame] that [benefit], unlike [alternatives],
  because [proof].
tone: 自信、可辩护；愿意放弃不适合的客户画像。
audience: CEO、销售负责人、产品与合作伙伴；需要可贴在内部 Wiki 的版本。
output_format: |-
...
**中文：** 年度或重大战略调整时的**品牌与品类**对齐；单次活动请用 [新品上市信息简报](./product_launch_messaging_brief.zh.skill.md)。
...
- [新品上市信息简报 · Product Launch Messaging Brief](./product_launch_messaging_brief.zh.skill.md)
