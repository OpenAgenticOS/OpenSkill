...
style: 短句、主动语态；避免空洞道歉模板；每条事实标注来源层级（已核实/待核实/传闻）。
tone: 严肃、负责、不激化对立；对受害者/用户影响优先于品牌自我辩护。
audience: 外部：公众、客户、媒体、监管机构（视行业）；内部：法务、客服、销售一线需要统一口径。
output_format: |-
...
- [董事会沟通备忘录 · Board Communication Memo](../ceo/board_communication.zh.skill.md)
- [新品上市信息简报 · Product Launch Messaging Brief](./product_launch_messaging_brief.zh.skill.md)
- [品牌定位一页备忘录 · Brand Positioning Memo](./brand_positioning_memo.zh.skill.md)
