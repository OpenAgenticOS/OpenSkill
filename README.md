...
[English](#english) · [中文](#中文) · [Vision 愿景](#vision) · [Contribute 贡献](#-如何贡献--how-to-contribute)
...
> **中文：** 打造可复用、可评审、双语的企业大模型技能库，覆盖从高管到一线岗位；社区通过 Issue/PR 模板贡献，CI 保障格式与质量。
>
> **English:** A reusable, reviewable, bilingual enterprise LLM skill library—from leadership to frontline roles—with community contributions via Issue/PR templates and CI guarding format and quality.
